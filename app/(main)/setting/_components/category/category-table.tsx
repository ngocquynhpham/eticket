...
import { Boxes, CirclePlus, CircleX, Edit } from "lucide-react";
...
const CategoryTable = ({ data }: { data: Category[] }) => {
  ...
  function handleSubmit() {
    if (formData.id) {
      actionUpdateCategory(formData as Category);
    } else {
  ...
  function handleDelete (){
    actionDeleteCategory(formData as Category);
      resetForm();
    ...
    <>
      ...
      >
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            <DialogTitle>
              {formData.id ? formData.name : "Create New Category"}
            </DialogTitle>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input
                ...
                value={formData.name}
                id="name"
                placeholder="Type name category here."
